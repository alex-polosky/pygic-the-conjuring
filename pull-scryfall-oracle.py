...
BASE_OUT = os.path.join(BASE_DIR, 'data', 'lib')

ORACLE_OUT = os.path.join(BASE_OUT, 'oracle-cards.json')
ORACLE_BULK_OUT = os.path.join(BASE_OUT, 'oracle-bulk.json')
NAMES_OUT = os.path.join(BASE_OUT, 'oracle-names.txt')
LEGEND_TOKEN_NAMES_OUT = os.path.join(BASE_OUT, 'oracle-legend-token-names.txt')
SETS_OUT = os.path.join(BASE_OUT, 'oracle-sets.json')

BASE_URL = 'http://api.scryfall.com/'
URI_KEY = 'download_uri'

# TODO: Add some progress bars or something
